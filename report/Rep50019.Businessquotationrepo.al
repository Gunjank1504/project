...
report 50019 Business_quotation_repo
{
    ApplicationArea = All;
    Caption = 'Business_quotation_repo';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = 'RDL/B_quotation.rdl';
    dataset
    {
        dataitem(SalesHeader; "Sales Header")
        {
            ...
            dataitem("Sales Line";"Sales Line")
            {
                ...
                SrNo += 1;
                    ...
                    Clear(Amountinwords);
                    InitTextVariable();
                    // finalamount := round(Amount, 0.01);
                    FormatNoText(Notext1, finalamount, "Sales Line"."Currency Code");
