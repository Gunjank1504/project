...
report 50002 kuber_deliveryChallan
{
    ApplicationArea = All;
    Caption = 'kuber_deliveryChallan';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = 'RDL/50002_KuberDellivery.rdl';
    dataset
    {
        dataitem(SalesShipmentHeader; "Sales Shipment Header")
        {
            ...
            dataitem("Sales Shipment Line"; "Sales Shipment Line")
            {
                ...
                begin
                    ...
                    if "Sales Shipment Line".FindFirst() then begin
                        repeat
                            taxinformation.Reset();
                            taxinformation.SetFilter("Tax Record ID", '%1', "Sales Shipment Line".RecordId);
            ...
            begin
                ...
                if transshipm.FindFirst() then begin
                    from_city := transshipm."Transfer-from City";
                    to_city := transshipm."Transfer-to City";
                end
            end;
        }
    }
