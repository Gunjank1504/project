report 60009 VPO_report
{
    ...
    dataset
    {
        dataitem(PurchaseHeader; "Purchase Header")
        {
            ...
            column(comprc;comp."Country/Region Code")
            {
        ...
        //   }
          column(vph;vph)
          {
            ...
            {
                // DataItemLink = "Document type" = field("No.");
           ...
           begin
            ven.Reset();
                ...
                // state1.SetRange(Code,ven."State Code");
