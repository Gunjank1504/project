        ...
        dataitem(PurchaseHeader; "Purchase Header")
        {
            ...
            dataitem("Purchase Line"; "Purchase Line")
            {
                ...
                begin
                    ...
                    InitTextVariable();
                    GSTAmt := Round(GSTrate, 0.01);
                    FormatNoText(Notext1, GSTrate, "Purchase Line"."Currency Code");
            ...
            begin
                cust.Reset();
                cust.SetRange("No.", PurchaseHeader."Sell-to Customer No.");
                if cust.FindFirst() then begin
                    sales_person := cust."Salesperson Code";
